        ...
        return (
            <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div className="flex flex-col sm:flex-row sm:items-start gap-6 animate-pulse">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 animate-pulse">
                        ...
                        <div className="grid grid-cols-3 gap-3 mb-6">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="bg-gray-50 rounded-lg p-4 text-center space-y-2">
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                    <p className="text-sm font-semibold text-gray-900">{student?.fullName || 'Student Detail'}</p>
