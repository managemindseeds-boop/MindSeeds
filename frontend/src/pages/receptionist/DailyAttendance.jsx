                ...
                <div className="flex flex-col md:flex-row gap-4 items-end">
                    ...
                    <div className="w-full md:w-1/3">
                        ...
                        <select
                            ...
                            className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#5e3174] focus:border-transparent transition-all outline-none"
                        >
                    ...
                    <div className="w-full md:w-1/3">
                        <button
                            ...
                            disabled={isFetching}
                            className="w-full py-2 bg-[#5e3174] text-white rounded-lg font-medium hover:bg-[#4a2860] transition-colors flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {isFetching ? (
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="flex justify-between items-center p-4 border-b border-gray-100 bg-gray-50/50">
                        ...
                        <button
                            ...
                            className="text-sm text-[#5e3174] font-medium hover:text-emerald-700 hover:bg-[#f0e6f6] px-3 py-1.5 rounded-md transition-colors cursor-pointer"
                        >
                            Mark All Present
                        </button>
                    </div>
                    ...
                    <div className="p-4 bg-gray-50/50 border-t border-gray-100">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg focus:ring-2 focus:ring-[#5e3174] focus:border-transparent transition-all outline-none resize-none h-24 mb-4"
                        />
                        ...
                        <div className="flex justify-end">
                            <button
                                onClick={handleSave}
                                disabled={isSaving}
                                className="px-6 py-2.5 bg-[#5e3174] hover:bg-emerald-700 text-white rounded-lg font-medium transition-colors flex items-center gap-2 shadow-sm shadow-[#5e3174]/20 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                            >
                                <Save size={18} />
